...
public class ProductController {
    ...
    public Long updateProduct(@PathVariable Long id, @RequestBody ProductMypriceRequestDto requestDto, HttpServletRequest request) {    // 토큰을 가져와야 하기 때문에 request 객체를 넣어준다.
        // 응답 보내기 (업데이트된 상품 id)
